      ...
      <div className="max-w-6xl mx-auto px-4 py-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              <Repeat size={16} />
              <span className="hidden sm:inline">{isLooping ? 'Looping' : 'Loop Off'}</span>
            </Button>
            ...
            <Button
              ...
              className="gap-1"
            >
              {showABControls ? <ChevronDown size={16} /> : <ChevronUp size={16} />}
          ...
          <div className="pt-2 pb-1 border-t border-gray-200 dark:border-gray-700 mt-2">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                >
                  <ChevronLeft size={16} />
                  <span className="ml-1">A: {loopStart !== null ? formatTime(loopStart) : "--:--"}</span>
                </Button>
                ...
                >
                  <span className="mr-1">B: {loopEnd !== null ? formatTime(loopEnd) : "--:--"}</span>
